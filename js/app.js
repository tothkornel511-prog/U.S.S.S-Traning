...
import { seedIfNeeded, globalSearch, getCustomCss, getOperationRecords } from "./store.js?v=50";
...
import { renderCovertOpList, renderCovertOpDetail } from "./pages/covert-ops.js?v=4";
