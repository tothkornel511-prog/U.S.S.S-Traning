...
import { seedIfNeeded, globalSearch, getCustomCss, getOperationRecords, SECTIONS } from "./store.js?v=64";
...
import { renderTrainingPlansList, renderTrainingPlanDetail } from "./pages/plans.js?v=6";
