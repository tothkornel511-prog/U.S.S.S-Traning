import { getProtocols, getProtocol, getPersonnel, createProtocol, moduleByCode, allModulesFlat } from "../store.js?v=66";
import { hasRole, actorLabel } from "../auth.js?v=20";
import { esc, fmtDate, fmtDateTime, toast, openModal, closeModal } from "../utils.js?v=25";
